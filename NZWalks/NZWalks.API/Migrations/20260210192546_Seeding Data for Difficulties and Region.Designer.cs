...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20260210192546_Seeding Data for Difficulties and Region")]
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("facbd018-7490-4719-928e-e23e56763361"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("f4c564fd-bccb-486d-860c-6a56c8c02234"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("2cff180b-f855-4cb4-a228-707ab5081546"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.Region", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9d7b6307-cee7-45f0-8536-708ff4fbfad3"),
                            Code = "AKL",
